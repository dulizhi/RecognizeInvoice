...
public class CurrencyUtil {
    ...
    public static String formatMoney(String money) {
        ...
        if(moneys!=null&&moneys.length>1){
            money=moneys[1];
        }
        return money.trim();
    }
    ...
    public static void main(String[] args){
        String priceTaxLow="￥14138.94";
        String[]  priceTaxLows=priceTaxLow.split("￥");
        if(priceTaxLows!=null&&priceTaxLows.length>1){
            priceTaxLow=priceTaxLows[1];
        }
        System.out.println("priceTaxLow:"+priceTaxLow.trim());
    }
}
