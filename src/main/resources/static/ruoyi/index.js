...
$(function() {
    ...
    function menuItem() {
        var menuT=$.trim($(this).text());
        document.getElementById("menuC").innerHTML=$.trim($(this).text());
        // 获取标识数据
  ...
  /*  function menuItem() {
        ...
        var str1 = '<iframe class="RuoYi_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
        $('.mainContent').find('iframe.RuoYi_iframe').hide().parents('.mainContent').append(str1);
        document.getElementById("tabContent").innerHTML=menuName;
        return false
    }*/
    function menuBlank() {
