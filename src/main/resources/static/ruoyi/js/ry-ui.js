    	...
    	modal: {
            ...
            alert: function(content, type) {
        	    layer.alert(content, {
        	        ...
        	        title: "系统提示",
        	        btn: ['确认'],
        	        btnclass: ['btn buttonL btn-success'],
        	    });
            },
            // 消息提示并刷新父窗体
            ...
            confirm: function (content, callBack) {
            	layer.confirm(content, {
        	        ...
        	        title: "系统提示",
        	        btn: ['确认', '取消'],
                    btnclass: ['btn buttonL btn-success','btn buttonL btn-default'],
        	    }, function (index) {
        	    	layer.close(index);
        	        callBack(true);
        	    });
            ...
            // 弹出层指定宽度
            open: function (title, url, width, height, callback,tag) {
    			var button =['确定', '关闭'];
    			if(tag=='save'){
                    button =['保存', '关闭'];
				}
        ...
        operate: {
            ...
            edit: function(id) {
            	if($.common.isEmpty(id) && $.table._option.type == table_type.bootstrapTreeTable) {
                    ...
                    $.modal.open("修改" + $.table._option.modalName, url,'','','','save');
            	} else {
            	    $.modal.open("修改" + $.table._option.modalName, $.operate.editUrl(id),'','','','save');
            	}
            },
            // 修改信息，以tab页展现
            editTab: function(id) {
